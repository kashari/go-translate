...
const OPEN_AI_ENV_VAR string = "OPEN_API_KEY"
const DEEPL_ENV_VAR string = "DEEPL_API_KEY"
const GOOGLE_ENV_VAR string = "GOOGLE_API_KEY"
const MICROSOFT_ENV_VAR string = "MICROSOFT_API_KEY"
const QCRI_ENV_VAR string = "QCRI_API_KEY"
const YANDEX_ENV_VAR string = "YANDEX_API_KEY"

var BASE_URLS = map[string]string{
...
var PONS_CODES_TO_LANGUAGES = map[string]string{
	"ar":    "arabic",
	"bg":    "bulgarian",
	"zh-cn": "chinese",
	"cs":    "czech",
...
var LINGUEE_LANGUAGES_TO_CODES = map[string]string{
	"maltese":    "maltese",
	"english":    "english",
	"german":     "german",
	"bulgarian":  "bulgarian",
...
var MY_MEMORY_LANGUAGES_TO_CODES = map[string]string{
	"acehnese":                           "ace-ID",
	"afrikaans":                          "af-ZA",
	"akan":                               "ak-GH",
	"albanian":                           "sq-AL",
...
var DEEPL_LANGUAGE_TO_CODE = map[string]string{
	"bulgarian":  "bg",
	"czech":      "cs",
	"danish":     "da",
	"german":     "de",
...
var PAPAGO_LANGUAGE_TO_CODE = map[string]string{
	"ko":    "Korean",
	"en":    "English",
	"ja":    "Japanese",
	"zh-CN": "Chinese",
...
var QCRI_LANGUAGE_TO_CODE = map[string]string{"Arabic": "ar", "English": "en", "Spanish": "es"}

var LIBRE_LANGUAGES_TO_CODES = map[string]string{
	"English":    "en",
	"Arabic":     "ar",
	"Chinese":    "zh",
	"French":     "fr",
...
var TENCENT_LANGUAGE_TO_CODE = map[string]string{
	"arabic":                "ar",
...
var BAIDU_LANGUAGE_TO_CODE = map[string]string{
	"arabic":                "ara",
	"bulgarian":             "bul",
